...
function () {
   ...
   function Xc(c) {
      var l, h, v, z, e, a, m, t, s, r, f, M, n, H, o, V, C, L, u, d = (h = Sc(l = c), v = h.iconName, z = h.prefix, e = h.rest, a = kc(l), m = Ac(l), t = qc(l), s = Oc(l), r = jc(l), {
         iconName: v,
      ...
      return ~d.extra.classes.indexOf(Rc) ? function (c, l) {
         var h = l.title,
            v = l.transform,
            z = l.extra,
            e = null,
            ...
            function () {
               D(c.querySelectorAll("*")).forEach(function (c) {
                  [":before", ":after"].forEach(function (l) {
                     ...
                     if (z && (z.nextSibling && z.nextSibling.textContent.indexOf(C) > -1 && Yc(z.nextSibling), Yc(z), z = null), v && !z) {
                        var e = h.getPropertyValue("content"),
                           a = t.createElement("i");
                        a.setAttribute("class", "" + Bc[v[1]]), a.setAttribute(C, l), a.innerText = 3 === e.length ? e.substr(1, 1) : e, ":before" === l ? c.insertBefore(a, c.firstChild) : c.appendChild(a)
                     }
                  })
               })
            }(), yc = !1, l()
   ...
   function Kc(c) {
      ...
      if (M) {
         var h = t.documentElement.classList,
            ...
            e = Object.keys(Ic),
            a = ["." + Rc + ":not([" + V + "])"].concat(e.map(function (c) {
               return "." + c + ":not([" + V + "])"
            })).join(", ");
         if (0 !== a.length) {
   ...
   var vl, zl = new Qc,
      el = (vl = function (c) {
         ...
         if (c) {
            ...
            return ll(k({
               ...
               return cl(), O.autoA11y && (s ? i["aria-labelledby"] = O.replacementClass + "-title-" + B() : i["aria-hidden"] = "true"), hc({
                  icons: {
                     main: Zc(C),
                     mask: m ? Zc(m.icon) : {
                        found: !1,
      ...
      ml = function () {
         M && O.autoReplaceSvg && al.dom.i2svg({
            node: t
         })
      };
   Object.defineProperty(al, "config", {
      ...
      function (c) {
         ...
         f && (m.FontAwesome || (m.FontAwesome = al), T(function () {
            Object.keys(E.styles).length > 0 && ml(), O.observeMutations && "function" == typeof MutationObserver && function (c) {
               if (s) {
                  ...
                  }), M && wc.observe(t.getElementsByTagName("body")[0], {
                     childList: !0,
                     attributes: !0,
                     characterData: !0,
                     subtree: !0
